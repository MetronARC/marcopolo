...
$routes->get('customer-database', 'Pages::customerDatabase', ['filter' => 'authGuard']);
$routes->get('sales-report', 'Pages::salesReport');
$routes->get('ship-inquiry', 'Pages::shipInquiry');
...
$routes->group('ticket', static function ($routes) {
    ...
    $routes->get('unfinish', 'Ticket::unfinish', ['filter' => 'authGuard']);
...
$routes->group('parts', static function ($routes) {
    ...
    $routes->get('getall', 'Parts::getall', ['filter' => 'authGuard']);
