<aside class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
          ...
          <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('cs') ?>">
                <i class="align-middle" data-feather="sliders"></i>
                <span class="align-middle">Customer Service</span>
              </a>
            </li>

            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= base_url('engineer') ?>">
                <i class="align-middle" data-feather="compass"></i>
                <span class="align-middle">Engineer</span>
              </a>
            </li>
